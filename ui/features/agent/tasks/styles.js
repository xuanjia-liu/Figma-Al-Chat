        ...
        },
{
          ...
          prompt: '',
          help: 'Runs fully on-device (No AI). Detach text/color/layout/corner bindings and optionally selected instances. Recursive mode includes descendants; instance detach only affects directly selected instances.',
          fields: [
            {
              key: 'detachFontStyle',
              type: 'checkbox',
            ...
            },
            {
              ...
              default: ['fontFamily', 'fontWeight', 'fontSize', 'lineHeight'],
              options: [
                { value: 'fontFamily', label: 'Font family', detail: 'Variable binding for family' },
                { value: 'fontWeight', label: 'Font weight', detail: 'Variable binding for weight / style' },
            ...
            },
            {
              ...
              default: false,
              hint: 'When off, non-instance detach applies to the selection and all descendants.',
            },
          ],
        },
{
